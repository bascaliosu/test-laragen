...
Route::name('laragen.')
    ...
    ->group(function () {
                            ...
                            Route::get('users/{user}/edit', [\App\Http\Controllers\User\UserController::class, 'edit'])->name('admin.users.edit');
                                                Route::get('cars', [\App\Http\Controllers\Cars\CarController::class, 'index'])->name('admin.cars.index');
                            Route::get('cars/create', [\App\Http\Controllers\Cars\CarController::class, 'create'])->name('admin.cars.create');
                            Route::get('cars/{car}', [\App\Http\Controllers\Cars\CarController::class, 'show'])->name('admin.cars.show');
                            Route::get('cars/{car}/edit', [\App\Http\Controllers\Cars\CarController::class, 'edit'])->name('admin.cars.edit');
