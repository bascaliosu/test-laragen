<x-laragen::form wire:submit.prevent="submit" class="pb-7 bg-white shadow rounded px-7">
                    @includeIf('app.user.user.create.fieldset.default-fieldset-8.before')
        <fieldset>

            
            <div class="flex-1 -mx-2">
                @includeIf('app.user.user.create.fieldset.default-fieldset-8.content_before')
                    ...
                    @includeIf('app.user.user.fields.create.email_after')
                                @includeIf('app.user.user.create.fieldset.default-fieldset-8.content_after')
            </div>

        </fieldset>
        @includeIf('app.user.user.create.fieldset.default-fieldset-8.after')
